...
export const Validator = {
  ...
  date(value: string): ValidationResult {
    ...
    if (isNaN(d.getTime())) return fail('日期格式无效');
    return ok();
  },
};
